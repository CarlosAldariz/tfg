...
(1, 'fugoneta', 'furgoneta.jpg', 'Alquila y viaja por la CDM buscando la ola perfecta' ),
(2, 'experiencia', 'experiencia.jpg', 'Surfea con nosotros!'),
(3, 'camiseta', 'camiseta.jpg', 'Welcome to the club!');
...
INSERT INTO Productos (CodProd, nombre, descripcion, imagen, CodCat) 
VALUES 
(1, 'furgo', 'No es la mejor, ni la más rapida, pero vivimos en el fin del mundo y con ella puedes ir al fin del mundo ¡no bebe mucho!', '', 1), 
(2, 'waves of the day', 'montate en nuestra van con tu tabla sin saber ni a donde vas, la playa con las mejore condiciones del día es el destino', '', 2), 
(3, 'clases', 'nos hemos sacado el papelito de monitor! ya podemos oficialmente enseñarte a surfear, la veteranía y la profesionalidad de nuestros monitores es avalada por una vida viviendo entre las olas', '', 2), 
(4, 'camiseta', 'quieres información de gente local y sacarles una sonrisa? Aparece con la camiseta de surfdamorte y estarás avalado por los surfistas más veteranos de la CDM', '', 3); 
...
('Socorrista', 'Servicio de vigilancia y rescate para garantizar la seguridad de los bañistas'),
('Duchas', 'Instalaciones de duchas disponibles para uso de los visitantes'),
('Risco Bioloxico', 'Playa con risco por medusas, tuburons, contaminación ... '),
('Chiringuito', 'Pequeño bar o restaurante en la playa que ofrece comidas y bebidas'),
('Bodyboard', 'Moi boas ondas para bodyboard'),
('Surf', 'Praia con ondas para surfistas'), 
('Parrilla', 'Parrillas fara facer asados');
