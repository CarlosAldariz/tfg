            ...
            <?php elseif (isset($resultado['nombre']) && isset($resultado['descripcion'])): ?>
                <div class="post">
                    ...
                    <?php if (isset($resultado['imagen'])): ?>
                        <div class="thumb">
                            <img src="<?php echo RUTA; ?>imagenes/productos/imagenes_tienda/<?php echo $resultado['imagen']; ?>" alt="<?php echo $resultado['nombre']; ?>" style="max-width: 100%; height: auto; overflow-clip-margin: content-box; overflow: clip;"> 
                        </div>
                    <?php endif; ?> 
            ...
            <?php elseif (isset($resultado['nombre']) && isset($resultado['descripcion']) && isset($resultado['stock'])): ?>
                <div class="post">
                    ...
                    <?php if (!empty($resultado['imagen'])): ?>
                        <div class="thumb">
                            <img style="overflow-clip-margin: content-box; overflow: clip;" src="<?php echo RUTA; ?>/imagenes/productos/imagenes_tienda/<?php echo $resultado['imagen']; ?>" alt="<?php echo $resultado['nombre']; ?>">
                        </div>
                    <?php endif; ?>
