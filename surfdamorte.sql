...
('editor', '$2y$10$m6P9.wuXpJd1PhvtDlQNCezhjagan4jwL9j/rqyZgBcEdfAk1bTd.', 1),
('usuario', '$2y$10$m6P9.wuXpJd1PhvtDlQNCezhjagan4jwL9j/rqyZgBcEdfAk1bTd.', 2),
('tienda', '$2y$10$m6P9.wuXpJd1PhvtDlQNCezhjagan4jwL9j/rqyZgBcEdfAk1bTd.', 3),
('root', '$2y$10$m6P9.wuXpJd1PhvtDlQNCezhjagan4jwL9j/rqyZgBcEdfAk1bTd.', 4),
('usuario2', '$2y$10$m6P9.wuXpJd1PhvtDlQNCezhjagan4jwL9j/rqyZgBcEdfAk1bTd.', 2);
...
INSERT INTO Productos (CodProd, nombre, descripcion, precio, imagen, CodCat, stock, estado) 
VALUES 
(1, 'tabla bodyboard', 'Óptima para iniciación', 100 , 'tabla_bd_inic.PNG', 1, 10, 1), 
(2, 'tabla surf', 'Para comenzar en las olas', 100 , 'tabla_srf_inic.PNG', 1, 10, 1),  
(3, 'tabla bodyboard pro', 'Para los riders más exigentes', 350 , 'tabla_bd_pro.PNG', 1, 10, 1), 
(4, 'tabla de surf pro', 'Para olas de todo tipo', 350 , 'tabla_surf_pro.PNG', 1, 10, 1), 
(5, 'neopreno corto talla M', 'Perfecto para la época veraniega', 150 , 'neopreno_corto.PNG', 2, 5, 1), 
(6, 'neopreno de invierno talla M', 'En esta zona puedes usarlo todo el año', 150 , 'neopreno_m.PNG', 2, 5, 1), 
(7, 'neopreno corto talla S', 'Perfecto para el verano', 100 , 'neopreno_corto.PNG', 2, 5, 1), 
(8, 'neopreno invierno talla L', 'Equipación pro de invierno', 150, 'neopreno_m.PNG', 2, 5, 1), 
(9, 'camiseta surf Da Morte S', 'Luce tus colores', 10, 'cdm.jpg', 3, 10, 1), 
(10, 'camiseta CDM 4life S', 'Algodón orgánico y mucho salitre', 15 , '4life.jpg', 3, 10, 1), 
(11, 'camiseta onlylocals S', 'Tú eres de aquí o ves la fiesta', 15 , 'only.jpg', 3, 10, 1), 
(12, 'camiseta surf Da Morte M', 'Luce tus colores', 15 , 'cdm.jpg', 3, 30, 1), 
(13, 'camiseta CDM 4life M', 'Algodón orgánico y mucho salitre', 15 , '4life.jpg', 3, 30, 1), 
(14, 'camiseta onlylocals M', 'Tú eres de aquí o ves la fiesta', 15 , 'only.jpg', 3, 30, 1), 
(15, 'camiseta surf Da Morte L', 'Luce tus colores', 15 , 'cdm.jpg', 3, 20, 1), 
(16, 'camiseta CDM 4life L', 'Algodón orgánico y mucho salitre', 15 , '4life.jpg', 3, 20, 1), 
(17, 'camiseta onlylocals L', 'Tú eres de aquí o ves la fiesta', 15, 'only.jpg', 3, 20, 1), 
(18, 'camiseta surf Da Morte XL', 'Luce tus colores', 15 , 'cdm.jpg', 3, 10, 1), 
(19, 'camiseta CDM 4life XL', 'Algodón orgánico y mucho salitre', 15, 'cdm.jpg', 3, 10, 1), 
(20, 'camiseta onlylocals XL', 'Tú eres de aquí o ves la fiesta', 15 , 'only.jpg', 3, 10, 1), 
(21, 'tabla bodyboard handcrafted', 'Artesanía de galicia, una obra de arte', 500 , 'tabla_bd_hand.PNG', 1, 10, 1), 
(22, 'tabla de surf pro', 'Artesanía de Galicia, una obra de arte', 500 , 'tabla_surf_hand.PNG', 1, 10, 1);
...
('Sesión de infarto', 'Un temporal trajo a Seaia unas olas trepidantes', 'Con el mal tiempo vienen las condiciones extremas y Seaia nunca defrauda cuando sale, siempre hay que ir a mirar esta playa porque sus olas son una delicia. Disfruta la foto de algo que se da muy pocas veces al año', 'seaia.jpg', 1), 
('Ruta dos faros & surf', '¿Qué hago un día sin olas?', 'La ruta de los faros nos ofrece una perfecta opción para conocer Costa da Morte a fondo, con todas las calas y playas. Una de las mejores actividades de senderismo a nivel mundial', 'rebor.jpg', 3), 
...
('Socorrista', 'Servicio de vigilancia e recate', 'Socorrista.png'),
('Duchas', 'Praia con duchas para endulzarse', 'ducha.png'),
('Risco', 'Playa con risco por medusas, tiburons, contaminación ... ', 'Risco.png'),
('Chiringuito', 'Pequeno bar ou restaurante', 'Chiringuito.png'),
...
INSERT INTO estados (Cod_Estado, Descripcion) VALUES
  ...
  CREATE TABLE IF NOT EXISTS pedidos (
    ...
    PRIMARY KEY (CodPed),
    FOREIGN KEY (id_usuario) REFERENCES Usuarios(id),
    FOREIGN KEY (id_estado) REFERENCES estados(Cod_Estado)
); 
